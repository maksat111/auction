...
import { MdVerified, MdOutlinePayment } from "react-icons/md";
...
const ProductDetails = ({ match }) => {
  ...
  const { product, loading, error, sellerDetails, winStatus } = useSelector(
  ...
  const startTimer = () => {
    ...
    interval = setInterval(() => {
      ...
      if (distance < 0) {
        ...
        setTimerDays(check(days));
        setTimerHours(check(hours));
        setTimerMinutes(check(minutes));
        setTimerSeconds(check(seconds));
      }
    }, 1000);
  };
                ...
                <div className="row s_product_inner">
                  ...
                  <div className="col-lg-5 offset-lg-1">
                    <div className="s_product_text">
                      ...
                      <ul className="list">
                        <li>
                          <a className="active" href="#">
                            <span>Kategoriýa</span> : {product.category}
                          </a>
                        </li>
                      ...
                      {countdownDate > now ? (
                        userData._id !== sellerDetails._id ? (
                          <PlaceBid product={product} />
                        ) : (
                          <div className="alert alert-primary" role="alert">
                            <MdVerified /> Önümiňiziň auksiony häzirki wagtda
                            işjeň!
                          </div>
                        )
                      ) : (
                        <h3> Auksion tamamlandy</h3>
                      )}
                    </div>
                  </div>
                </div>
                        ...
                        <div className="tab-pane card" id="tab-2">
                          <div className="row gy-4">
                            <div
                              ...
                              id="profile-overview"
                            >
                              <h5 className="card-title">Haryt maglumatlary</h5>
                          ...
                          <div className="row gy-4">
                            {countdownDate > now ? (
                              <div
                                ...
                                id="profile-overview"
                              >
                                <h5 className="card-title">Auksion ýagdaýy</h5>
                                <div className="row">
                                  <div className="col-lg-3 col-md-4 label ">
                                    Ýagdaýy
                                  </div>
                                  <div className="col-lg-9 col-md-8">
                                    Häzirki wagtda auksion işjeňdir
                                  </div>
                                </div>
                              </div>
                            ) : (
                                    ...
                                    {showButton && (
                                      <div className="stripecls">
                                        ...
                                        >
                                          <button class="button">
                                            <MdOutlinePayment />{" "}
                                            <span>Zolak bilen birikdiriň </span>
                                          </button>
                                        </StripeCheckout>
                                      </div>
                                    )}
